// This package contains some functionality used for creating generators for boilerplate code.
package generator

import "go/ast"

// The default comment at the top of generated files.
const HeaderNote = `/**
* THE CODE OF THIS FILE IS AUTOMATICALLY GENERATED AND SHOULD NOT BE EDITED MANUALLY.
*/
`

// Contains the base values included in other elements like structs, fields and so on.
type Base struct {
